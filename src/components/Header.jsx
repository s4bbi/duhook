    ...
    <div>
      <div>
        <div className="flex bg-black text-white items-center font-[poppins] px-5 gap-x-24 hustify-between">
          ...
          <span className="font-rM font-bold pt-5 cursor-pointer">DuHook</span>
          </div>
          ...
          <div className="flex ">
          <FaSistrix className="text-sky-500 w-20 h-6 font-medium cursor-pointer"/>
          <FaAlignJustify className="text-sky-500 w-12 h-6 cursor-pointer"/>
